...
const LS_KEY = 'generic_business_customer_reviews'
...
const CATEGORY_COLLAGES: Record<string, [string, string, string]> = {
  ...
  'Product Powder':       [V2 + 'Manjal Podi.jpeg',         V2 + 'Thulasi Podi.jpeg',        V2 + 'Ashwagandha Podi.jpeg'],
  'Product Oil':          [V2 + 'Veppa ennai.jpeg',         V2 + 'Thenga Ennai.jpeg',        V2 + 'Vilakennai Oil.jpeg'],
...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    location: 'Coimbatore',
    rating: 5,
    text: 'The product oils are absolutely pure and give real results. Ordered multiple times and every batch smells fresh and aromatic. Best nattu marundhu shop online!',
    initials: 'currency',
    color: '#8B7355',
  },
  {
...
export default function Home() {
  ...
  return (
    <div className="bg-[#fbf8f2] text-[#111111]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full mb-6
              bg-[#8a5b3d]/10 border border-[#8a5b3d]/20">
              <Sparkles size={11} className="text-[#7a5038]" />
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[#7a5038]">
                {t('hero.badge')}
              </span>
            </div>
            ...
            <h1 className={`font-black mb-5 break-words ${
              ...
              <span className="block text-[#8a5b3d]">{t('hero.title2')}</span>
            </h1>
            ...
            <p className="text-[13px] sm:text-[14px] font-semibold text-[#8a5b3d]/75
            ...
            <div className="flex flex-wrap gap-3 items-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5
                  ...
                  text-[13px] sm:text-[14px]
                  shadow-sm
                  hover:bg-[#fbf8f2] hover:border-[#111111]/20
                  transition-all duration-200"
              >
                <Leaf size={13} className="text-[#8a5b3d]" />
                {t('remedy.title')}
              </a>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <div className="bg-white rounded-2xl px-4 py-3.5
                ...
                border border-[#e4d6c5]/50
                flex items-center gap-3">
                <div className="w-8 h-8 rounded-xl bg-[#8a5b3d] flex items-center justify-center shrink-0">
          ...
          {[
            ...
            <div key={idx}
              className="flex items-center gap-3.5 p-4 sm:p-5
                ...
                border border-[#e4d6c5]/35
                shadow-sm
                hover:-translate-y-0.5 transition-transform duration-200"
            >
              <div className="w-9 h-9 rounded-xl bg-[#8a5b3d]/12 flex items-center justify-center shrink-0 text-[#8a5b3d]">
                {item.icon}
              </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        <div className="flex justify-between items-end mb-10">
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.22em] text-[#8a5b3d] mb-2">Browse Collection</p>
          ...
          <Link to="/products"
            className="text-[13px] font-bold text-[#8a5b3d] flex items-center gap-1 group hover:text-[#7a5038] transition-colors">
            {t('cat.view_all')}
            ...
            >
              <Link to={`/products?cat=${encodeURIComponent(c.name)}`} className="flex flex-col items-center group">
                ...
                <div className="w-full aspect-square rounded-2xl overflow-hidden relative
                  border border-[#e4d6c5]/30 shadow-sm
                ...
                <span className="text-[10px] sm:text-[11px] font-bold text-[#111111] text-center leading-tight
                  group-hover:text-[#8a5b3d] transition-colors duration-200">
                  {c.name}
                </span>
              </Link>
            </motion.div>
      ...
      {/* ═══ HEALTH CONCERNS ═══ */}
      <section id="concerns" className="bg-white py-16 sm:py-24 border-y border-[#e4d6c5]/30 scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <div className="mb-12">
            <p className="text-[10px] font-black uppercase tracking-[0.22em] text-[#8a5b3d]">{t('remedy.badge')}</p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        <div className="flex justify-between items-center mb-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.18em] text-[#8a5b3d]">Customer Favourites</p>
          ...
          <Link to="/products"
            className="text-[13px] font-bold text-[#8a5b3d] hover:text-[#7a5038] flex items-center gap-1 transition-colors">
      ...
      <section className="bg-white py-16 sm:py-24 border-y border-[#e4d6c5]/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.22em] text-[#8a5b3d]">Customer Reviews</p>
          ...
          <AnimatePresence>
            {showForm && (
              <motion.form
                ...
                className="mb-10 bg-[#fbf8f2] rounded-2xl p-6 border border-[#e4d6c5]/40 overflow-hidden"
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-xl border-2 border-[#e4d6c5] focus:border-[#8a5b3d] outline-none bg-white text-[13px]"
                ...
                <div className="mb-5">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border-2 border-[#e4d6c5] focus:border-[#8a5b3d] outline-none bg-white text-[13px] resize-none"
                ...
                <div className="flex gap-3">
                  <button type="submit" disabled={submitting}
                    className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-[#8a5b3d] hover:bg-[#7a5038] text-white font-bold text-[13px] transition-colors disabled:opacity-60">
                    {submitting
                  ...
                  <button type="button" onClick={() => { setShowForm(false); setReviewError('') }}
                    className="px-5 py-2.5 rounded-xl border-2 border-[#e4d6c5] text-[#374151] font-bold text-[13px] hover:bg-[#fbf8f2] transition-colors">
                    Cancel
                  </button>
                </div>
              </motion.form>
          ...
          {reviewsLoading && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-5">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="bg-[#fbf8f2] rounded-2xl p-5 border border-[#e4d6c5]/30 animate-pulse">
                  <div className="h-3 bg-[#e4d6c5] rounded w-24 mb-4" />
                  <div className="h-2.5 bg-[#e4d6c5] rounded w-full mb-2" />
                  <div className="h-2.5 bg-[#e4d6c5] rounded w-4/5 mb-2" />
                  <div className="h-2.5 bg-[#e4d6c5] rounded w-3/5" />
                </div>
              ))}
            </div>
          )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {TESTIMONIALS.map((review, idx) => (
              <motion.div
                ...
                className="bg-[#fbf8f2] rounded-2xl p-5 sm:p-6 border border-[#e4d6c5]/30 flex flex-col gap-3.5 hover:shadow-md transition-shadow duration-300"
              >
                ...
                <div className="flex items-center gap-2.5 pt-3 border-t border-[#e4d6c5]/40">
            ...
            {customerReviews.slice(0, 8).map((review) => {
              const colors = ['#8a5b3d', '#C4845C', '#8B7355', '#7a5038']
              ...
              return (
                <motion.div
                  ...
                  animate={{ opacity: 1, scale: 1 }}
                  className="bg-[#fbf8f2] rounded-2xl p-5 sm:p-6 border border-[#8a5b3d]/20 flex flex-col gap-3.5 hover:shadow-md transition-shadow duration-300"
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[9px] font-bold text-[#8a5b3d] bg-[#8a5b3d]/10 px-2 py-0.5 rounded-full">Verified</span>
                  </div>
                  <p className="text-[13px] text-[#374151] leading-[1.65] flex-grow">&ldquo;{review.text}&rdquo;</p>
                  <div className="flex items-center gap-2.5 pt-3 border-t border-[#e4d6c5]/40">
                    <div className="w-8 h-8 rounded-full flex items-center justify-center text-white text-[10px] font-black shrink-0"
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2.5 px-9 py-4
                ...
                hover:bg-[#fbf8f2] hover:scale-[1.02]
                transition-all duration-200
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-stretch">
          ...
          <a
            ...
            className="group relative rounded-[2rem] overflow-hidden
              border border-[#e4d6c5]/40 shadow-sm
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 z-10">
              ...
              <div className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl
                ...
                group-hover:bg-[#8a5b3d] transition-colors duration-300">
          ...
          <div className="bg-white rounded-[2rem] p-8 sm:p-10
            ...
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.22em] text-[#8a5b3d]">Find Us</p>
              ...
              <p className="text-[#374151] text-[14px] leading-[1.7] font-medium mb-6">
                Visit Specson for optical billing, spectacles, frames, lenses, and services. Our team will help you find the right option for your needs.
              </p>

              <div className="space-y-3.5">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-[#8a5b3d]/12 flex items-center justify-center shrink-0">
                    <MapPin size={16} className="text-[#8a5b3d]" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-[#8a5b3d]/12 flex items-center justify-center shrink-0">
                    <Phone size={16} className="text-[#8a5b3d]" />
                  </div>
                  <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-16 sm:pb-24 text-center">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2.5 px-10 py-4 rounded-full
            bg-[#8a5b3d] text-white font-black
            shadow-[0_4px_20px_rgba(125,170,143,0.35)]
            hover:bg-[#7a5038] hover:scale-[1.02] hover:shadow-[0_6px_28px_rgba(125,170,143,0.45)]
            transition-all duration-200
            text-[13px] sm:text-[14px]"
        >
