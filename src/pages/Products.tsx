...
export default function Products() {
  ...
  const SkeletonCard = () => (
    <div className="rounded-2xl border border-[#e4d6c5]/50 bg-white overflow-hidden animate-pulse">
      <div className="aspect-square bg-[#e4d6c5]/30" />
      <div className="p-3 space-y-2">
        <div className="h-2 bg-[#e4d6c5]/40 rounded w-1/2" />
        <div className="h-3 bg-[#e4d6c5]/40 rounded w-4/5" />
        <div className="h-3 bg-[#e4d6c5]/30 rounded w-3/5" />
        <div className="flex gap-1 mt-2">
          {[1,2,3,4].map(i => <div key={i} className="h-5 bg-[#e4d6c5]/30 rounded-lg w-10" />)}
        </div>
        <div className="flex justify-between items-center pt-2 border-t border-[#e4d6c5]/30 mt-2">
          <div className="h-5 bg-[#e4d6c5]/40 rounded w-14" />
          <div className="h-8 bg-[#e4d6c5]/40 rounded-xl w-16" />
        </div>
      </div>
    </div>
  )
  ...
  return (
    <div className="bg-bgMain min-h-screen">
      {/* Header Panel */}
      <div className="bg-white border-b border-[#e4d6c5]/30">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-grow">
          ...
          {loading ? (
            ...
            <div className="bg-white border border-[#e4d6c5]/40 rounded-3xl p-10 sm:p-20 text-center flex flex-col items-center">
               <div className="w-20 h-20 bg-[#fbf8f2] rounded-full flex items-center justify-center mb-6">
                 <Search className="text-[#e4d6c5]" size={32}/>
               </div>
               ...
               <button onClick={clear} className="text-sm font-black text-[#8a5b3d] hover:underline">Clear all filters</button>
            </div>
          ) : (
