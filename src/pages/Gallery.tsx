    ...
    <div className="bg-[#fbf8f2] min-h-screen">
      ...
      >
        ...
        >
          ...
          <p className="text-[16px] sm:text-[18px] font-black text-[#8a5b3d] mb-4">
            Serving Chennai Since 1945
          </p>
          <p className="text-[15px] text-[#374151] font-medium leading-[1.7] max-w-lg mx-auto">
            Explore our traditional product and pooja store through real photographs
          ...
          {galleryImages.map((img, idx) => (
            ...
            >
              <div className="relative overflow-hidden rounded-[20px] sm:rounded-[24px]
                ...
                transition-shadow duration-300 bg-[#e4d6c5]/20">
                <img
                  src={img.image}
                  alt={img.title}
                  loading="lazy"
