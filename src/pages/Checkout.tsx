      ...
      <div className="mobile-page-shell py-16">
        <div className="max-w-lg mx-auto px-4">
          <div className="surface-panel p-8 text-center">
            ...
            {/* Summary */}
            <div className="bg-[#fbf8f2] rounded-xl p-4 mb-4 text-sm text-left space-y-1.5">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <span className="flex items-center px-3 py-3 bg-[#fbf8f2] border-2 border-sand rounded-xl text-[13px] font-bold text-textMuted shrink-0">
                    🇮🇳 +91
                  </span>
                  <input
                    value={form.phone}
                ...
                {form.phone && !isValidPhone(form.phone) && (
                  <p className="mt-1 text-xs text-red-500 font-medium">Invalid number — enter a 10-digit Indian mobile number or +91 number</p>
                )}
                {form.phone && isValidPhone(form.phone) && (
