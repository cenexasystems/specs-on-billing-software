  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          <p className="text-[10px] font-black uppercase tracking-[0.26em] text-[#8a5b3d] mb-3">
          ...
          <p className="text-[15px] text-[#374151] font-medium leading-[1.7] max-w-lg mx-auto">
            Explore our traditional product and pooja store, where quality and authenticity
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
          ...
          <div className="w-full lg:w-[35%] shrink-0">
            ...
            <motion.p
              ...
              className="hidden lg:block text-[10px] font-black uppercase tracking-[0.26em] text-[#8a5b3d] mb-4"
            >
              A Glimpse of Our Tradition
            </motion.p>
            ...
            >
              Explore our traditional product and pooja store, where quality and
